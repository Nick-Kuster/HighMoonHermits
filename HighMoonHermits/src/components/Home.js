...
const fullCircle = 'https://i.imgur.com/SVc7q4h.png';
const background = 'https://i.imgur.com/DzgIdCj.jpg';
const hermanUrl = 'https://i.imgur.com/1NyQK9L.png';
const hmh = 'https://i.imgur.com/BdFcxtD.png';
const hmh1 = 'https://i.imgur.com/b9vxFzf.png';
...
function HomeLayout({blogs}){
    ...
    return (
        <React.Fragment>
            ...
            <img className={classes.hmh} src={hmh}/>
            </Paper>
            <Paper className={classes.paper}>
                    <div  className={classes.blogsGrid}>
                        <div className={classes.title}><Typography variant='h2' className={classes.titleText}>NEWS</Typography></div>
                        {blogList({blogs})}
                    </div>
                    <div  className={classes.eventsGrid}>
                    
                            <div className={classes.title}>
                                <Typography variant='h2' className={classes.titleText}>UPCOMING EVENTS</Typography>
                            </div>
